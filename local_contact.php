                ...
                <div class="position-absolute w-75 p-5 bg-white mb-4 rounded"
                    ...
                    <form>
                        ...
                        <input type="submit" value="SEND"
                            class="btn border-0 form-control text-center text-light font-weight-bold"
        ...
        <div class="row" style=" background-color:#FE3B48;">
            <div class="col-md-12" style="background-color:#FE3B48;">
                ...
                <div class="d-flex mb-3">
                    <a href="./index.php" class="d-block py-2 text-light mx-5">HOME</a>
                    <a href="./sell_books.php" class="d-block py-2 text-light mr-5">SELL BOOKS</a>
                    <!-- <a href="./articles.php" class="d-block py-2 text-light mr-5">ARTICLES</a> -->
                    <a href="./contact.php" class="d-block py-2 text-light">CONTACT</a>
                </div>
